    ...
    <div className="space-y-1.5">
      ...
      {history.map((item, idx) => {
        ...
        return (
          <div
            key={idx}
            className="rounded-lg border border-[rgba(15,23,42,0.06)] dark:border-[rgba(255,255,255,0.05)] bg-gray-50/50 dark:bg-[#0d1322]/50 overflow-hidden"
          >
            <div className="px-3 py-2 flex items-center gap-3">
              ...
              <div className="flex items-center gap-0.5">
                <button
                  ...
                  className="p-1 rounded hover:bg-gray-200 dark:hover:bg-[#1a2340] text-gray-300 dark:text-gray-600 hover:text-accent transition-colors"
                  title="Відновити"
                >
                ...
                <button
                  ...
                  className={`p-1 rounded hover:bg-gray-200 dark:hover:bg-[#1a2340] text-gray-300 dark:text-gray-600 hover:text-gray-500 dark:hover:text-gray-400 transition-all ${isExpanded ? 'rotate-180' : ''}`}
                  title="Деталі"
                >
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {isExpanded && item.details && (
              <div className="px-3 pb-2 border-t border-[rgba(15,23,42,0.04)] dark:border-[rgba(255,255,255,0.04)] pt-1.5 animate-fade-in">
                <div className="space-y-0.5 text-2xs">
                  ...
                  <div className="border-t border-[rgba(15,23,42,0.04)] dark:border-[rgba(255,255,255,0.03)] my-0.5" />
...
function HRow({ label, value, plus, minus, bold, accent }) {
  ...
  return (
    <div className="flex justify-between py-0.5">
      ...
      <span className={`tabular-nums font-medium ${bold ? 'font-semibold' : ''} ${color}`}>
